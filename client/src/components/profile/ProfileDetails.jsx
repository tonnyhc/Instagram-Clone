...
const ProfileDetails = ({ profileData, friendship_status, setProfile, }) => {
  ...
  return (
    <>
      ...
      <div className={styles.detailsWrapper}>
        {isProfileOwner ? (
          <ChangePictureModal pictureHeigth='150px' pictureWidth='150px' pictureSrc={profileData.profile_picture} setProfile={setProfile} newProfilePicture={newProfilePicture} pictureInputRef={pictureInputRef}/>
        ) : (
          <div className={styles.profilePicture}>
            <img
              src={`${profileData.profile_picture}`}
